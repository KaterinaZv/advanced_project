...
const config = {
  ...
  // cacheDirectory: "/private/var/folders/nn/ggzwb6191ssbmghh04vwn1880000gn/T/jest_dx",
  ...
  // as % or a number. E.g. maxWorkers: 10% will use 10% of your CPU amount + 1 as the maximum
  ...
  testPathIgnorePatterns: ['/node_modules/', '/..fttemplates'],
